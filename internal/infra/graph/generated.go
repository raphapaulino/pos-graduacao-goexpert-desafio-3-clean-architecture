...
import (
	...
	"github.com/raphapaulino/pos-graduacao-goexpert-desafio-3-clean-architecture/internal/infra/graph/model"
...
func (ec *executionContext) field_Mutation_createOrder_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalOOrderInput2ᚖgithubᚗcomᚋraphapaulinoᚋposᚑgraduacaoᚑgoexpertᚑdesafioᚑ3ᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOOrder2ᚖgithubᚗcomᚋraphapaulinoᚋposᚑgraduacaoᚑgoexpertᚑdesafioᚑ3ᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_listOrders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Order)
	fc.Result = res
	return ec.marshalOOrder2ᚕᚖgithubᚗcomᚋraphapaulinoᚋposᚑgraduacaoᚑgoexpertᚑdesafioᚑ3ᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOOrder2ᚕᚖgithubᚗcomᚋraphapaulinoᚋposᚑgraduacaoᚑgoexpertᚑdesafioᚑ3ᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v []*model.Order) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOOrder2ᚖgithubᚗcomᚋraphapaulinoᚋposᚑgraduacaoᚑgoexpertᚑdesafioᚑ3ᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOOrder2ᚖgithubᚗcomᚋraphapaulinoᚋposᚑgraduacaoᚑgoexpertᚑdesafioᚑ3ᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) unmarshalOOrderInput2ᚖgithubᚗcomᚋraphapaulinoᚋposᚑgraduacaoᚑgoexpertᚑdesafioᚑ3ᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderInput(ctx context.Context, v interface{}) (*model.OrderInput, error) {
	if v == nil {
		return nil, nil
	}
